...
namespace juan_sumulong_learning_app
{
    public partial class StudentInformation : Form
    {
        ...
        private void scanRecords()
        {
            ...
            //mysql
            string[,] result = _database.ExecuteQuery("select Stud_ID, LastName, FirstName, MiddleName, Year, Name from tbl_student, tbl_sections where tbl_student.Section_ID = tbl_sections.Section_ID");
            for (int i = 0; i < result.GetLength(0); i++)
            {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (_avatarpath != String.Empty)
                if (_database.InsertRecord("tbl_students",
                    ...
                    new WebServer("http://localhost/").UploadFile(_avatarpath, "ITS/avatars/" + lblStudentNumber.Text);
        }
